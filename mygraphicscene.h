...
public:
    ...
    QString addOperations(double x=0, double y=0, double width=100, double height=30); // Метод для добавления операции на сцену
    void updateOperations(int index,double x, double y, double width, double height);  // Метод для обновления операции на сцене
